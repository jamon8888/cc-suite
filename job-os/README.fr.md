...
/job-os {coller une JD}  → Auto-pipeline complet (évaluation + PDF + tracker)
/job-os scan             → Scanner les portails pour de nouvelles offres
/job-os linkedin-scan    → Scanner LinkedIn via le navigateur (session Chrome requise)
/job-os pdf              → Générer un CV optimisé ATS
/job-os batch            → Évaluer plusieurs offres en batch
...
Ou collez simplement une URL ou description de poste directement — job-os la détecte automatiquement et lance le pipeline complet.
...
Je suis Santiago — Head of Applied AI, ex-fondateur (j'ai construit et vendu une entreprise qui tourne encore avec mon nom dessus). J'ai construit job-os pour gérer ma propre recherche d'emploi. Ça a marché.

Mon portfolio et autres projets open source → [santifer.io](https://santifer.io)

☕ [Offrir un café](https://buymeacoffee.com/santifer) si job-os a aidé votre recherche d'emploi.

## Avertissement légal

**job-os est un outil local open source — PAS un service hébergé.** En utilisant ce logiciel, vous reconnaissez :
...
Embauché grâce à job-os ? [Partagez votre histoire !](https://github.com/santifer/job-os/issues/new?template=i-got-hired.yml)
