...
- Suggest the user run `/job-os contacto {company}` to find the right person first
...
> - Trying a different contact via `/job-os contacto`
...
**To:** {email or "No contact found — run `/job-os contacto` first"}
