# job-os -- Modos em Portugues BR (`modes/pt/`)

Esta pasta contem as traducoes em portugues brasileiro dos principais modos do job-os para candidatos que buscam vagas no mercado brasileiro ou em empresas que operam em portugues.
...
O job-os nao tem um "switch de idioma" como flag de codigo. Em vez disso, existem dois caminhos:
