# Geteilter Kontext -- job-os (Deutsch)

<!-- ============================================================
     ANPASSEN DIESER DATEI
     ============================================================
     Diese Datei enthält den geteilten Kontext für alle job-os-Modi
     in der deutschen Variante. Bevor du job-os verwendest, MUSST du:
