---
description: "Poser une question a ta base de connaissances. Repond uniquement depuis le wiki, avec citations et niveaux de confiance."
...
3. **Verify**: Read `<wiki-root>/_index.md`. If missing or no compiled articles -> stop: "Pas de wiki trouve. Lance /copywriter:recherche ou /copywriter:apprendre pour commencer."
