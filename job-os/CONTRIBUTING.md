...
- Report bugs via [Issues](https://github.com/santifer/job-os/issues)
...
- **PRs that enable auto-submitting applications** without human review. job-os is a decision-support tool, not a spam bot.
...
- [Open an issue](https://github.com/santifer/job-os/issues)
