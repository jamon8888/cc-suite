...
- **Offer**: `data/2-Domaines/business-profile.json` (What is the "Mechanism"?).
- **Pain**: `data/2-Domaines/icp.json` (What is the "Hell" they are in?).
- **Dream**: `data/2-Domaines/icp.json` (What is the "Heaven" they want?).
