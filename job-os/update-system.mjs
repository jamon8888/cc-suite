...
/**
 * update-system.mjs — Safe auto-updater for job-os
 *
...
const CANONICAL_REPO = 'https://github.com/santifer/job-os.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/santifer/job-os/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/santifer/job-os/releases/latest';
