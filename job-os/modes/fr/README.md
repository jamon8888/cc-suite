# job-os -- Modes francophones (`modes/fr/`)

Ce dossier contient les traductions francaises des principaux modes job-os pour les candidats qui ciblent le marche francophone (France, Belgique, Suisse romande, Luxembourg, Quebec).
