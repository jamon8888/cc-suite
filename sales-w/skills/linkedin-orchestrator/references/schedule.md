...
- Log everything to `data/LinkedIn/activity_log.md`

### Startup Sequence

```
1. Determine current time block (based on system time)
2. Read `data/sales-profile.json` → Language & Geo
3. Read `data/LinkedIn/activity_log.md` → Today's progress
4. Read `data/LinkedIn/prospects.md` → Cached prospects
...
- **CRITICAL**: Update `data/LinkedIn/activity_log.md` immediately after each task
