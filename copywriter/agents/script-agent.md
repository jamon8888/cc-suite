...
```
READ data/2-Domaines/voice-dna.json → extract: energy_level, rhetorical_mechanisms, signature_phrases
READ data/2-Domaines/icp.json → extract: platform_preferences, sophistication_level
```
