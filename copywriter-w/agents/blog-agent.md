...
```
READ data/voice-dna.json → extract: tone, rhetorical_mechanisms, forbidden_words
READ data/icp.json       → extract: language_patterns, pain_points, primary_content_target
READ data/business-profile.json → extract: primary_offer, CTAs, positioning
```
