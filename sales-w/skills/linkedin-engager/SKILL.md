...
- **Reads**: `data/sales-profile.json` (for `selling_methodology` alignment).
- **Reads**: `data/LinkedIn/prospects.md` (for prospect status).
- **Reads**: `data/LinkedIn/activity_log.md` (for touch history).
