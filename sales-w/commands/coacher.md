---
description: "Coaching: review email, roleplay, feedback. Enrichi par patterns wiki."
...
```
/sales:coacher                          # Full weekly coaching review
/sales:coacher deals                    # Focus on deal-specific coaching only
/sales:coacher outreach                 # Focus on outreach and messaging
/sales:coacher [company]               # Coaching on a specific deal
/sales:coacher skills                   # Identify and practice skill gaps
```
...
Before coaching:
1. Read win/loss analysis articles from wiki for recurring patterns
2. Use wiki intelligence to identify skill gaps backed by data (not just current session)
3. Cross-reference coaching recommendations with wiki-documented objection patterns and loss categories
4. If win/loss patterns exist in wiki, prioritize coaching on the most frequent loss category
...
This week: Run /sales:preparer GlobalTech.
...
Practice: Run /sales:coacher roleplay -- Discovery persona, CFO character.
