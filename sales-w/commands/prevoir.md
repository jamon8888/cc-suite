---
description: "Prevision pipeline avec scoring wiki."
...
### Wiki Confidence Weighting

Weight forecast by article confidence scores per deal:
1. For each deal in pipeline, check wiki for account-specific articles
2. Deals with high-confidence wiki research (confidence >= 0.8) get a +5% probability boost
3. Deals with no wiki research get a -5% probability penalty (unknown territory)
4. Deals with stale wiki research (last_verified > 30 days) get flagged: "Recherche obsolete -- prevision moins fiable"
5. Include wiki confidence in forecast output as a separate column
...
| Stage       | # Deals | Total Value | Probability | Wiki Confidence | Weighted Value |
| ----------- | ------- | ----------- | ----------- | --------------- | -------------- |
| Negotiation | [X]     | $[X]        | 80%         | [high/med/low]  | $[X]           |
| Proposal    | [X]     | $[X]        | 60%         | [high/med/low]  | $[X]           |
| Evaluation  | [X]     | $[X]        | 40%         | [high/med/low]  | $[X]           |
| Discovery   | [X]     | $[X]        | 20%         | [high/med/low]  | $[X]           |
| **Total**   | [X]     | $[X]        | --          | --              | $[X]           |
