...
```
READ data/voice-dna.json → extract: intimacy level, rhetorical_mechanisms, forbidden_words
READ data/business-profile.json → extract: primary_offer, language_preference
READ data/icp.json → extract: sophistication level, pain_points, vocabulary
```
