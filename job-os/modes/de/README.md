# job-os — Deutsche Modi (`modes/de/`)

Dieser Ordner enthält die deutschen Übersetzungen der wichtigsten job-os-Modi für Bewerber:innen, die im DACH-Raum (Deutschland, Österreich, Schweiz) suchen oder mit deutschen Stellenanzeigen arbeiten.
...
job-os hat keinen "Sprach-Schalter" als Code-Flag. Stattdessen gibt es zwei Wege:
...
| `angebot.md` | `modes/offre.md` (ES) | Vollständige Bewertung einer einzelnen Stellenanzeige (Blöcke A-F) |
...
Die übrigen Modi (`scan`, `batch`, `pdf`, `tracker`, `auto-pipeline`, `deep`, `contacto`, `offres`, `project`, `training`) sind absichtlich nicht in diesem PR dabei. Sie funktionieren weiter über die EN/ES-Originale, weil ihr Inhalt zu großen Teilen aus Tooling, Pfaden und Konfigurationskommandos besteht — diese sollen sprachunabhängig bleiben.
