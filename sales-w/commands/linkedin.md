---
description: "Suite LinkedIn: post, engage, prospect, orchestrate."
...
1. Query wiki `topics/` for recent articles with high confidence scores
2. Use wiki intelligence (market trends, competitor analysis, industry data) as content angles
3. Generate post ideas based on wiki knowledge gaps or recent discoveries
4. Reference wiki sources for data-backed claims in posts
...
```python
# 1. Load Context
profile = read_json("data/sales-profile.json")
activity_log = read_file("data/LinkedIn/activity_log.md")
