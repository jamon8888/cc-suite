...
- **Business Goals**: `data/2-Domaines/business-profile.json` — what is being sold, offer type
- **Audience**: `data/2-Domaines/icp.json` — pain points, vocabulary, trust barriers
- **Voice**: `data/2-Domaines/voice-dna.json` — format matches style
...
2. **Your best client** — "Does this month's content address what they're struggling with right now?"
3. **Competitor** — "If a direct competitor saw this calendar, what would they do to outflank it?"
4. **New subscriber** — "Someone finds you for the first time. What impression does this month create?"
5. **Search intent** — "What are people actually typing when they have this problem?"
