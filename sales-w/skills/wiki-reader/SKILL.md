...
description: >
  ...
  containing .wiki/ or when ~/sales-wiki/ exists. Also activates on "what do we know
...
1. Resolve the hub path: try `$HOME/sales-wiki/_index.md`, else read `~/.config/llm-sales-wiki/config.json`
