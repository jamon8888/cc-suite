---
description: "Conseil negociation fonde sur wiki + patterns win/loss."
...
```
/sales:negocier "Price is too high"     # Objection Handling
/sales:negocier script "Procurement"    # Script Generation
/sales:negocier roleplay "CFO Battle"   # Simulation Mode
```
...
Before dispatching negotiation advice:
1. Read objection patterns from wiki articles (entity_type: competitor, win-loss)
2. Read win/loss analysis articles for recurring objection patterns
3. Use wiki intelligence to contextualize: competitor pricing, known objections, historical outcomes
4. If account-specific articles exist, tailor advice to the account's buying behavior

---

## /sales:negocier "Price is too high"
...
## /sales:negocier roleplay "Specific Scenario"
