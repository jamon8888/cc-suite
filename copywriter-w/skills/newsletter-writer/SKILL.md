...
- Voice DNA: `data/voice-dna.json` (tone, signature phrases)
- ICP: `data/icp.json` (what they're struggling with today)
- Business Profile: `data/business-profile.json` (primary offer)
