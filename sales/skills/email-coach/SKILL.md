...
**Load Context**:
- `data/2-Domaines/voice-dna.json` — What does the user's natural voice sound like?
- `data/2-Domaines/icp.json` — Who is this email going to?
- `data/2-Domaines/sales-profile.json` — What language mode?
