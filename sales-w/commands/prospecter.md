---
description: "Trouver et engager des prospects. Enrichi par ta base wiki."
...
```
/sales:prospecter "SaaS CTO in Paris"   # Quick Search
/sales:prospecter inbound               # Check who viewed your profile
/sales:prospecter url [LINKEDIN_URL]    # Analyze a specific list/post
```
...
Before prospecting, check wiki for existing articles on target sector:
1. Grep wiki `topics/` for keywords matching the prospect query
2. Read matching articles (entity_type: competitor, market, account)
3. Use wiki intelligence to refine ICP criteria and search terms
4. If sector articles found, extract known pain points and buying signals to improve fit scoring

---

## /sales:prospecter "SaaS CTO"
...
Suggested Next Step:
/sales:creer "email" for Jean Dupont (Start Warming)
```

---

## /sales:prospecter inbound
...
2.  **Competitor Poaching**: Go to a competitor's post. Run `/sales:prospecter url [POST_URL]`. Scrape the dissatisfied commenters.
