...
8. Add `content_angles` in frontmatter — 2-4 suggested hooks a copywriter could use to turn this research into content (e.g., `content_angles: ["Why X matters for Y", "The hidden cost of Z"]`)
...
During compilation, generate 2-4 content angles for each article — these are suggested hooks a copywriter could use to turn this research into content. Format as short phrases: "Why X matters for Y", "The hidden cost of Z", "N things about X that will surprise you".
