...
```
READ data/2-Domaines/business-profile.json → extract: price, guarantee, bonuses, mechanism
READ data/2-Domaines/icp.json → extract: hell_state (problem), heaven_state (dream), objections, failed_solutions
READ data/2-Domaines/voice-dna.json → extract: formality, forbidden_words, proof_style
```
